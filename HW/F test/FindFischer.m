...
%f_95 ni1 ni2 are the table f_95 and associated degrees of freedom


if RestrParam>120
    RestrParam=300; %Turned infinity into "300" so that I can easily do the math
end

if NumOfParams>120
    NumOfParams=300; %Turned infinity into "300" so that I can easily do the math
end



%Renaming so I could type less
n1=RestrParam;
n2=NumOfParams;
%%%%%%%%%%%%%%
